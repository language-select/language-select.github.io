...
!(function (
  ...
  const _isPROD_ = true; //document.currentScript.src.includes("min"); // won't be available in Events/Asyncs/import
  ...
  // **************************************************************************
  const __FLAGS_JS_ = `./select-flags${_isPROD_ ? ".min" : ""}.js`;
  // **************************************************************************
  ...
  customElements.define(
    ...
    class LS extends HTMLElement {
      connectedCallback() {
        // ====================================================================== TEST CLICK
        if (!_isPROD_) setTimeout(() => this.click(), 500);
        // ====================================================================== TEST CLICK
