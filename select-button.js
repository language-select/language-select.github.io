...
!(function (
  ...
  customElements.define(
    ...
    class LS extends HTMLElement {
      connectedCallback() {
        // ====================================================================== TEST CLICK
        if (_isDEV_) setTimeout(() => this.click(), 500);
        // ====================================================================== TEST CLICK
        ...
        if (this.hasAttribute("options")) {
          ...
          let selected_iso = this.getAttribute("selected") || "en";
          let display_iso =
            selected_iso == "gb" || selected_iso == "us" ? "en" : selected_iso;
          elements = [
            createElement("style", {
            ...
            createElement("div", {
              ...
              innerHTML:
                ...
                `</svg>` +
                `<span part="labeliso">${display_iso.toUpperCase()}</span>` +
                `<span part="labellanguage">${
                  this.languages[this.getAttribute("selected") || "en"]
                }</span>`,
            }),
          ];
          ...
          // make reference from detailed web component possible:
